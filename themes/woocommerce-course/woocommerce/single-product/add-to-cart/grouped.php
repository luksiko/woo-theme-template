...
<form class="cart grouped_form"
	...
	<div class="group-product-wrap table-responsive mt-40 mt-sm-26 mt-md-26">
          ...
          foreach ($grouped_product_columns as $column_id) {
              ...
              switch ($column_id) {
                  ...
                  case 'label':
                      ...
                      $value .= '</label>';
                      $my_class = 'product-list';
                      break;
                  case 'price':
                      $value = $grouped_product_child->get_price_html() . wc_get_stock_html($grouped_product_child);
                      $my_class = 'product-price';
                      break;
                  default:
                      $value = '';
                      $my_class = '';
              ...
              echo '<td class="' . $my_class . ' woocommerce-grouped-product-list-item__' . esc_attr($column_id) . '">' . apply_filters('woocommerce_grouped_product_list_column_' . $column_id, $value, $grouped_product_child) . '</td>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        ...
        <?php do_action('woocommerce_before_add_to_cart_button'); ?>
			<div class="quantity-btn-group">
				<div class="list-btn-group">
					<button type="submit"
					        class="single_add_to_cart_button btn btn-black"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
				</div>
			</div>
