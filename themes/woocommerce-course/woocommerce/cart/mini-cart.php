...
<div class="widget_shopping_cart_content"> <!--Необходимо добавить этот класс для обновления по AJAX-->
          ...
          foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
              ...
              if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key)) {
                  ...
                  ?>
                    ...
                    <?php
                    echo sprintf(
                        '<a href="%s" class="remove remove-icon remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">&#215;</a>',
